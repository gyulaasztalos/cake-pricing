...
HU: dict[str, str] = {
    ...
    "stats.kpi.margin": "Nyereség (üzleti)",
    "stats.kpi.margin_hint": "végleges ár − (anyag + munkadíj + rezsi)",
    "stats.chef_income": "Anita bevétele (kész munkákból)",
    "stats.chef_income_hint": "munkadíj + borravaló",
    "stats.tip": "Borravaló",
