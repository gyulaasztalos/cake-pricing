...
HU: dict[str, str] = {
    ...
    "offers.status.deposit": "Előlegezve",
    "offers.status.rejected": "Elutasítva",
    "offers.status.done": "Kész",
    "offers.status.cancelled": "Lemondás",
    "offers.core_data": "Alapadatok",
    "offers.items": "Tételek",
    "offers.add_recipe": "Recept hozzáadása",
    "offers.save_as_recipe": "Mentés receptként",
    "offers.copy": "Ajánlat másolása",
    ...
    "offers.per_portion": "{price} / szelet",
    ...
    "recipes.name": "Név",
    "recipes.notes": "Megjegyzés",
    "recipes.item_count": "tétel",
    "recipes.save_empty": "Nincs menthető tétel — az Alap csoport nem kerül a receptbe.",
    # inventory
    ...
    "settings.pricing": "Árazás",
    "settings.default_profit_pct": "Alapértelmezett nyereség %",
    "settings.default_profit_pct_hint": (
        "Az új ajánlatokon előre kitöltött üzleti nyereség. A meglévő ajánlatokat nem módosítja."
    ),
    ...
    "stats.tip": "Borravaló",
    "stats.shortfall": "Hiány",
    "stats.cancellation": "Lemondási díj",
    ...
    "stats.biz_profit.avg_pct": "Átlagos profit %",
    "stats.biz_profit.avg": "Átlagos profit",
    "stats.biz_profit.total": "Összes profit",
    ...
    "stats.sponges": "Legnépszerűbb piskóták",
    "stats.flavors": "Legnépszerűbb ízek",
    "stats.themes": "Leggyakoribb témák",
    "stats.portions": "Ajánlatok szeletszám szerint",
    "stats.portions_hint": "csak az árazott, szeletszámmal megadott ajánlatok",
    "stats.kpi.per_portion": "Átlagos szeletár",
    "stats.kpi.per_portion_hint": "a végleges árak alapján",
    "stats.source": "Forrás",
